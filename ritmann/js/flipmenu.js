...
// ## Images to use (specify full path)
	flipImg_open   = "../imagenes/flip_open.gif";
	flipImg_closed = "../imagenes/flip_closed.gif";
	flipImg_static = "../imagenes/flip_static.gif";

// ## Initialise all flipMenus onload
	flipInitOnLoad = true;

// ## Message to display in status bar while loading
	flipLoadingMessage = "Espere...";
...
"ul.flipMenu li ul li { text-indent: -25px; }" +
